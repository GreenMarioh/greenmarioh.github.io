...
// Added FaCode to the imports below
import { FaJava, FaGithub, FaExternalLinkAlt, FaPlus, FaUserSecret, FaCode } from 'react-icons/fa';
...
const projects = [
  ...
  },
  {
    ...
    description: "Whipper is a versatile Discord bot designed to enhance your gaming community's experience with a suite of useful and fun features.",
  ...
  },
  {
    ...
    description: "Allows you to convert a Spotify playlist into a private YouTube playlist by searching for matching videos.",
...
const skills = { 
    Programming: [ { name: "C/C++", icon: <SiCplusplus />, special: true }, { name: "JavaScript", icon: <SiJavascript /> },{ name: "Python", icon: <SiPython /> }, { name: "Java", icon: <FaJava />}, { name: "TypeScript", icon: <SiTypescript /> }, ], 
    Web: [ { name: "HTML", icon: <SiHtml5 /> }, { name: "CSS", icon: <SiCss3 /> }, { name: "ReactJS", icon: <SiReact />}, { name: "NodeJS", icon: <SiNodedotjs /> }, ], 
    Database: [ { name: "MySQL", icon: <SiMysql /> }, { name: "PostgreSQL", icon: <SiPostgresql /> }, ], 
    Security: [ { name: "Kali Linux", icon: <SiKalilinux /> }, { name: "Nmap", icon: <TbTargetArrow /> }, { name: "Metasploit", icon: <GiBrandyBottle />}, { name: "Burp Suite", icon: <GiBrandyBottle />}, ], 
...
const profiles = [
    ...
    { name: "Codolio", url: "https://codolio.com/profile/GreenMario", icon: <FaCode />, desc: "Coding Portfolio Tracker" }
];
    ...
    return (
        <section id="tech" className="tech-container">
            ...
            <div className="subsection">
                ...
                <p className="subsection-description">Problem solving and competitive programming.</p>
